...
local g = loadstring(game:HttpGet("https://github.com/reed192512/jayyhubcloud/releases/download/Jayyware/jayyware.txt"))();
local f  = loadsrting(game:HttpGet("https://raw.githubusercontent.com/reed192512/jayyhubcloud/main/SaveManager"))();
local c = loadstring(game:HttpGet("https://raw.githubusercontent.com/reed192512/jayyhubcloud/main/InterfaceManager"))();
local j = g.Options;
f:SetLibrary(g);
local h = g:CreateWindow({
Title = "JayyHubv2","",
SubTitle = "Where the fun begins. Powered By Jayyware.  jayy's Birthday script",
TabWidth=160,Size=UDim2.fromOffset(580, 460),Acrylic=true,Theme="\x44\x61\x72\x6B"});
