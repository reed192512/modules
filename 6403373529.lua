-- WARNING: ANY CHANGES MAY LEAD TO CRASHE THE SYSTEM
...
AntiLava.CanCollide = false
                ...
                local Window = OrionLib:MakeWindow({Name = "JayyHubv2| Slap Royale", HidePremium = true, IntroEnabled = false, SaveConfig = false, ConfigFolder = "OrionTest"})
...
elseif game.PlaceId == 11520107397 then
                ...
                local Window = OrionLib:MakeWindow({Name = "JayyHubv2| Killstreak Only", HidePremium = true, IntroEnabled = false, SaveConfig = false, ConfigFolder = "OrionTest"})
